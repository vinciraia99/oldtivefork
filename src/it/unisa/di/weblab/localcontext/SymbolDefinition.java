...
/*La classe memorizza le informazioni di un determinato simbolo
 ...
 * occurrences - Vincolo relativo al numero di occorrenze del simbolo
 * attacchingPoints - Insieme degli attacching point
...
public class SymbolDefinition {
	...
	public SymbolDefinition(String name, String graphicRepresentation,
			String occurrences,	ArrayList<AttacchingPoint> attacchingPoints,String localConstraint) {
	...
	public String toString(){
		String content="";
		content = content +"Name: "+name+" Graphic Representation: "+graphicRepresentation+" Occurrences: "+occurrences+" Attacching Points: \n";
	...
	private String name,graphicRepresentation,occurrences,localConstraint;
	private ArrayList<AttacchingPoint> attacchingPoints;
}
