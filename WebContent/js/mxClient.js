var mxClient = {
    ...
    link: function (a, b, c) {
        c = c || document;
        if (mxClient.IS_IE6) c.write('\x3clink rel\x3d"' + a + '" href\x3d"' + b + '" charset\x3d"ISO-8859-1" type\x3d"text/css"/\x3e'); else {
...
var mxEffects = {
                    ...
                    if (k instanceof mxGeometryChange || k instanceof mxTerminalChange || k instanceof mxValueChange || k instanceof mxChildChange || k instanceof mxStyleChange) {
                        ...
                        if (null != l) if (g = !0, k.constructor != mxGeometryChange || a.model.isEdge(k.cell)) mxUtils.setOpacity(l.shape.node, 100 * d / 10); else {
                            var m = a.getView().scale, n = (k.geometry.x - k.previous.x) * m, p = (k.geometry.y -
                                    k.previous.y) * m, q = (k.geometry.width - k.previous.width) * m,
    ...
    mxUtils = {
        ...
        remove: function (a, b) {
            var c = null;
            if ("object" == typeof b) for (var d = mxUtils.indexOf(b, a); 0 <= d;) b.splice(d,
        ...
        fit: function (a) {
            var b = parseInt(a.offsetLeft), c = parseInt(a.offsetWidth), d = document.body,
                e = document.documentElement, f = (d.scrollLeft || e.scrollLeft) + (d.clientWidth || e.clientWidth);
        ...
        arcToCurves: function (a, b, c, d, e, f, g, h, k) {
            ...
            c = Math.abs(c);
            d = Math.abs(d);
            var l = -h / 2, m = -k / 2, n = Math.cos(e *
                Math.PI / 180), p = Math.sin(e * Math.PI / 180);
            e = n * l + p * m;
            ...
            for (var v = Math.cos(f), w = Math.sin(f), q = -l * (m * w + d * v), s = -l * (c * w - n * v), t = r = 0, p = [], u = 0; u < g; ++u) {
                f += e;
                var v = Math.cos(f), w = Math.sin(f), r = m * v - d * w + h, t = c * v + n * w + k,
                    y = -l * (m * w + d * v), v = -l * (c * w - n * v), w = 6 * u;
                p[w] = Number(q + a);
                p[w + 1] = Number(s + b);
                p[w + 2] = Number(r - y + a);
                p[w + 3] = Number(t - v + b);
        ...
        getBoundingBox: function (a, b) {
            ...
            if (null != a && null != b && 0 != b) {
                var d = mxUtils.toRadians(b), c = Math.cos(d), e = Math.sin(d), f =
                        new mxPoint(a.x + a.width / 2, a.y + a.height / 2), g = new mxPoint(a.x, a.y),
                    d = new mxPoint(a.x + a.width, a.y), h = new mxPoint(d.x, a.y + a.height),
                    k = new mxPoint(a.x, h.y), g = mxUtils.getRotatedPoint(g, c, e, f),
                    d = mxUtils.getRotatedPoint(d, c, e, f), h = mxUtils.getRotatedPoint(h, c, e, f),
        ...
        reversePortConstraints: function (a) {
            var b = 0, b = (a & mxConstants.DIRECTION_MASK_WEST) << 3,
        ...
        intersectsHotspot: function (a, b, c, d, e, f) {
            ...
            f = null != f ? f : 0;
            if (0 < d) {
                var g = a.getCenterX(), h = a.getCenterY(), k = a.width, l = a.height,
        ...
        getOffset: function (a, b) {
            var c = 0, d = 0;
            if (null != b && b) var e = document.body, f = document.documentElement,
                c = c + (e.scrollLeft || f.scrollLeft), d = d + (e.scrollTop || f.scrollTop);
        ...
        setOpacity: function (a, b) {
            mxUtils.isVml(a) ? a.style.filter = 100 <= b ? null : "alpha(opacity\x3d" + b / 5 + ")" : mxClient.IS_IE && ("undefined" === typeof document.documentMode || 9 > document.documentMode) ? a.style.filter = 100 <= b ? null : "alpha(opacity\x3d" + b + ")" : a.style.opacity = b / 100
        },
        createImage: function (a) {
            var b = null;
            mxClient.IS_IE6 && "CSS1Compat" != document.compatMode ? (b = document.createElement(mxClient.VML_PREFIX + ":image"), b.setAttribute("src", a), b.style.borderStyle = "none") : (b = document.createElement("img"), b.setAttribute("src",
        ...
        popup: function (a, b) {
            if (b) {
                ...
                c.setClosable(!0);
                c.setVisible(!0)
            } else mxClient.IS_NS ? (c = window.open(), c.document.writeln("\x3cpre\x3e" + mxUtils.htmlEntities(a) + "\x3c/pre"), c.document.close()) : (c = window.open(), d = c.document.createElement("pre"), d.innerHTML = mxUtils.htmlEntities(a, !1).replace(/\n/g, "\x3cbr\x3e").replace(/ /g, "\x26nbsp;"), c.document.body.appendChild(d))
        },
        alert: function (a) {
            alert(a)
        },
...
var mxEvent = {
    ...
    redirectMouseEvents: function (a, b, c, d, e, f, g) {
        ...
        mxEvent.addListener(a, "dblclick", function (a) {
            if (null !=
                g) g(a); else if (!mxEvent.isConsumed(a)) {
                var c = h(a);
    ...
    release: function (a) {
        if (null != a && (mxEvent.removeAllListeners(a), a = a.childNodes, null != a)) for (var b = a.length, c = 0; c < b; c += 1) mxEvent.release(a[c])
    },
...
mxWindow.prototype.setResizable = function (a) {
    a ? null == this.resize ? (this.resize = document.createElement("img"), this.resize.style.position = "absolute", this.resize.style.bottom = "2px", this.resize.style.right = "2px", this.resize.setAttribute("src", mxClient.imageBasePath + "/resize.gif"), this.resize.style.cursor = "nw-resize", mxEvent.addGestureListeners(this.resize, mxUtils.bind(this, function (a) {
            this.activate();
            var c = mxEvent.getClientX(a), d = mxEvent.getClientY(a), e = this.div.offsetWidth, f = this.div.offsetHeight,
                g = mxUtils.bind(this,
                    function (a) {
...
mxWindow.prototype.installMinimizeHandler = function () {
    ...
    var a = !1, b = null, c = null, d = mxUtils.bind(this, function (d) {
        ...
        if (a) a = !1, this.minimize.setAttribute("src",
            this.minimizeImage), this.minimize.setAttribute("title", "Minimize"), this.contentWrapper.style.display = "", this.maximize.style.display = b, mxClient.IS_IE || (this.div.style.height = c), this.table.style.height = c, null != this.resize && (this.resize.style.visibility = ""), this.fireEvent(new mxEventObject(mxEvent.NORMALIZE, "event", d)); else {
            a = !0;
    ...
    var a = !1, b = null, c = null, d = null, e = null, f = mxUtils.bind(this, function (f) {
        ...
        if ("none" != this.maximize.style.display) {
            if (a) {
                ...
                if (!mxClient.IS_IE && (this.div.style.height = d, this.div.style.width = e, h = mxUtils.getCurrentStyle(this.contentWrapper), "auto" == h.overflow || null != this.resize)) this.contentWrapper.style.height = this.div.offsetHeight - this.title.offsetHeight -
                    2 + "px";
...
mxDragSource.prototype.mouseDown = function (a) {
    this.enabled && (!mxEvent.isConsumed(a) && null == this.mouseMoveHandler) && (this.startDrag(a), this.mouseMoveHandler = mxUtils.bind(this, this.mouseMove), this.mouseUpHandler = mxUtils.bind(this, this.mouseUp), mxEvent.addGestureListeners(document, null, this.mouseMoveHandler, this.mouseUpHandler), mxEvent.consume(a, !0, !1))
};
...
mxDragSource.prototype.dragOver = function (a, b) {
    var c = mxUtils.getOffset(a.container), d = mxUtils.getScrollOrigin(a.container),
        e = mxEvent.getClientX(b) - c.x + d.x, c = mxEvent.getClientY(b) - c.y + d.y;
    ...
    if (null != this.previewElement) {
        ...
        if (null != this.currentGuide && this.currentGuide.isEnabledForEvent(b)) var f = parseInt(this.previewElement.style.width),
            ...
            c = this.currentGuide.move(f, c, d), f = !1, e = c.x, c = c.y; else if (d) var d = a.view.scale,
...
mxSession.prototype.notify = function (a, b, c) {
    null != a && 0 < a.length && (null != this.urlNotify && (this.debug ? (mxLog.show(), mxLog.debug("mxSession.notify: " + this.urlNotify + " xml\x3d" + a)) : (a = "\x3cmessage\x3e\x3cdelta\x3e" + a + "\x3c/delta\x3e\x3c/message\x3e", this.escapePostData && (a = encodeURIComponent(a)), mxUtils.post(this.urlNotify, "xml\x3d" + a, b, c))), this.sent += a.length, this.fireEvent(new mxEventObject(mxEvent.NOTIFY, "url", this.urlNotify, "xml", a)))
};
...
mxPopupMenu.prototype.showSubmenu = function (a, b) {
    if (null != b.div) {
        ...
        var c = parseInt(b.div.offsetLeft), d = parseInt(b.div.offsetWidth), e = document.body,
...
mxSvgCanvas2D.prototype.addNode = function (a, b) {
    ...
    if (null != c) {
        ...
        a && null != d.fillColor ? this.updateFill() : this.styleEnabled || ("ellipse" == c.nodeName && mxClient.IS_NS && !mxClient.IS_GC && !mxClient.IS_SF ? c.setAttribute("fill", "transparent") : c.setAttribute("fill", "none"), a = !1);
...
mxSvgCanvas2D.prototype.image = function (a, b, c, d, e, f, g, h) {
    ...
    this.root.appendChild(l);
    this.blockImagePointerEvents && (l.setAttribute("style", "pointer-events:none"), l = this.createElement("rect"), l.setAttribute("visibility", "hidden"), l.setAttribute("pointer-events", "fill"), l.setAttribute("x", this.format(a * k.scale)), l.setAttribute("y",
...
mxSvgCanvas2D.prototype.createDiv = function (a, b, c, d, e) {
    ...
    mxUtils.isNode(a) || (c = document.createElement("textarea"), c.innerHTML = a.replace(/&lt;/g, "\x26amp;lt;").replace(/&gt;/g, "\x26amp;gt;").replace(/</g, "\x26lt;").replace(/>/g, "\x26gt;"), a = c.value, e ? d += b : 0 < b.length && (a = '\x3cdiv xmlns\x3d"http://www.w3.org/1999/xhtml" style\x3d"display:inline-block;' +
        b + '"\x3e' + a + "\x3c/div\x3e"));
...
mxSvgCanvas2D.prototype.text = function (a, b, c, d, e, f, g, h, k, l, m, n) {
    if (this.textEnabled && null != e) {
        ...
        if (this.foEnabled && "html" == k) {
            ...
            m ? (q += "overflow:hidden;", 0 < d && (q += "max-height:" + Math.round(d) + "px;"), 0 < c && (q += "width:" + Math.round(c) + "px;")) : l && (q += "width:" + Math.round(c) + "px;", 0 < d && (q += "max-height:" + Math.round(d) + "px;"));
            ...
            if (null != q) {
                ...
                if (mxClient.IS_IE && !mxClient.IS_SVG) {
                    ...
                    k.appendChild(q)
                } else this.root.ownerDocument != document ? (q.style.visibility = "hidden", document.body.appendChild(q), s = q.offsetWidth, d = q.offsetHeight, k.appendChild(q), q.style.visibility = "") : (k.appendChild(q), s = q.offsetWidth, d = q.offsetHeight);
                c = l ? Math.max(c, s) : s;
                1 > p.alpha && h.setAttribute("opacity", p.alpha);
                l = e = 0;
                ...
                0 != p.rotation && this.rotateHtml ? (f += "rotate(" + p.rotation + "," + c / 2 + "," + d / 2 + ")", b = this.rotatePoint((a + c / 2) * p.scale, (b + d / 2) * p.scale, p.rotation, p.rotationCx, p.rotationCy), a = b.x - c * p.scale / 2, b = b.y - d * p.scale / 2) : (a *= p.scale, b *= p.scale);
                0 != n && (f += "rotate(" + n + "," + -e + "," + -l + ")");
...
mxSvgCanvas2D.prototype.plainText = function (a, b, c, d, e, f, g, h, k, l, m) {
    ...
    var q = e.split("\n"), s = Math.round(n * mxConstants.LINE_HEIGHT), r = n + (q.length -
        1) * s;
    m = b + n - 1;
    g == mxConstants.ALIGN_MIDDLE ? (d = (this.matchHtmlAlignment && l && 0 < d ? Math.min(r, d) : r) / 2, m -= d + 1) : g == mxConstants.ALIGN_BOTTOM && (d = this.matchHtmlAlignment && l && 0 < d ? Math.min(r, d) : r, m -= d + 2);
    for (d = 0; d < q.length; d++) 0 < q[d].length && 0 < mxUtils.trim(q[d]).length && (l = this.createElement("text"), l.setAttribute("x", this.format(a * h.scale)), l.setAttribute("y", this.format(m * h.scale)), mxUtils.write(l, q[d]), p.appendChild(l)), m += s;
    this.root.appendChild(p);
...
mxSvgCanvas2D.prototype.addTextBackground = function (a, b, c, d, e, f, g, h, k) {
    ...
    if (null != l.fontBackgroundColor || null != l.fontBorderColor) {
        ...
        (m.style.fontStyle = "italic"), b = mxUtils.htmlEntities(b, !1), m.innerHTML = b.replace(/\n/g, "\x3cbr/\x3e"), document.body.appendChild(m), e = m.offsetWidth, f = m.offsetHeight, m.parentNode.removeChild(m), g == mxConstants.ALIGN_CENTER ? c -= e / 2 : g == mxConstants.ALIGN_RIGHT && (c -= e), h == mxConstants.ALIGN_MIDDLE ? d -= f / 2 : h == mxConstants.ALIGN_BOTTOM && (d -= f), m = new mxRectangle((c + 1) * l.scale, (d + 2) * l.scale, e * l.scale, (f + 1) * l.scale));
...
mxVmlCanvas2D.prototype.createFill = function () {
    ...
    if (null != a.gradientColor) {
        ...
        var c = 180 - a.rotation,
            c = a.gradientDirection == mxConstants.DIRECTION_WEST ? c - (90 + ("x" == this.root.style.flip ? 180 : 0)) : a.gradientDirection == mxConstants.DIRECTION_EAST ? c + (90 + ("x" == this.root.style.flip ? 180 : 0)) : a.gradientDirection == mxConstants.DIRECTION_NORTH ? c - (180 + ("y" == this.root.style.flip ?
...
mxVmlCanvas2D.prototype.createShadow = function (a, b, c) {
    var d = this.state, e = -d.rotation * (Math.PI / 180), f = Math.cos(e), e = Math.sin(e), g = d.shadowDx * d.scale,
...
mxVmlCanvas2D.prototype.createDiv = function (a, b, c, d) {
    ...
    mxUtils.isNode(a) ? c.appendChild(a) : 0 < f.length && !d ? (d = document.createElement("div"), d.style.cssText = f, d.style.display = mxClient.IS_QUIRKS ? "inline" : "inline-block", d.style.zoom = "1", d.innerHTML = a, c.appendChild(d)) : (c.style.cssText = f, c.innerHTML = a);
    a = c.style;
...
mxVmlCanvas2D.prototype.text = function (a, b, c, d, e, f, g, h, k, l, m, n) {
    if (this.textEnabled && null != e) {
        ...
        if ("html" == k) {
            ...
            "DIV" != this.root.nodeName ? (n = document.createElement(mxClient.VML_PREFIX + ":rect"), n.stroked = "false", n.filled = "false", n.appendChild(k), this.root.appendChild(n)) : this.root.appendChild(k);
            m ? (e.style.overflow = "hidden", 0 < c && (e.style.width = Math.round(c) + "px"), 0 < d && 8 == document.documentMode && (e.style.maxHeight = Math.round(d) + "px")) : l && (e.style.width = c + "px", 0 < d && (e.style.maxHeight = Math.round(d) +
                "px"));
            if (this.rotateHtml && 0 != h) {
                ...
                "hidden", document.body.appendChild(e), c = e.offsetWidth, q = e.offsetHeight, mxClient.IS_QUIRKS && (m && q > d) && (q = d, e.style.height = q + "px"), d = q, e.style.visibility = "", p.appendChild(e), k.style.left = this.format(a + c * r * this.state.scale) + "px", k.style.top = this.format(b + d * s * this.state.scale) + "px") : (1 > this.state.alpha && (e.style.filter = "alpha(opacity\x3d" + 100 * this.state.alpha + ")"), q.style.left = 100 * r + "%", q.style.top = 100 * s + "%")
...
mxGuide.prototype.move = function (a, b, c) {
    if (null != this.states && (this.horizontal || this.vertical) && null != a && null != b) {
        var d = this.graph.getView().translate, e = this.graph.getView().scale, f = b.x, g = b.y, h = !1, k = !1,
            l = this.getGuideTolerance(), m = l, n = l, l = a.clone();
        l.x += b.x;
        l.y += b.y;
        var p = l.x, q = l.x + l.width, s = l.getCenterX(), r = l.y, t = l.y + l.height, v = l.getCenterY();
        b = function (b) {
            b += this.graph.panDx;
            var c = !1;
        ...
        for (var l = function (b) {
            b += this.graph.panDy;
            var c = !1;
            Math.abs(b - v) < n ? (g = b - a.getCenterY(), n = Math.abs(b - v), c = !0) : Math.abs(b - r) < n ? (g = b - a.y, n = Math.abs(b - r), c = !0) : Math.abs(b - t) < n && (g = b - a.y - a.height, n = Math.abs(b - t), c = !0);
            if (c) {
            ...
            var u = this.states[w];
            null != u && (this.horizontal && (b.call(this, u.getCenterX()), b.call(this, u.x), b.call(this, u.x + u.width)), this.vertical && (l.call(this, u.getCenterY()), l.call(this, u.y), l.call(this, u.y + u.height)))
        }
...
mxShape.prototype.createCanvas = function () {
    var a = null, b = null;
    if (null != this.node.ownerSVGElement) a = new mxSvgCanvas2D(this.node, !1), a.strokeTolerance = this.svgStrokeTolerance, a.blockImagePointerEvents = mxClient.IS_NS && !mxClient.IS_SF && !mxClient.IS_GC, b = this.getSvgScreenOffset(), 0 != b ? this.node.setAttribute("transform", "translate(" + b + "," + b + ")") : this.node.removeAttribute("transform"); else {
...
mxShape.prototype.paint = function (a) {
    var b = this.scale, c = this.bounds.x / b, d = this.bounds.y / b, e = this.bounds.width / b,
...
mxRectangleShape.prototype.updateHtmlFilters = function (a) {
    ...
    this.isShadow && (b += "progid:DXImageTransform.Microsoft.dropShadow (OffX\x3d'" + Math.round(mxConstants.SHADOW_OFFSET_X * this.scale) + "', OffY\x3d'" + Math.round(mxConstants.SHADOW_OFFSET_Y * this.scale) + "', Color\x3d'" + mxConstants.SHADOWCOLOR + "')");
    if (this.gradient) {
        var c = this.fill, d = this.gradient, e = "0", f = {east: 0, south: 1, west: 2, north: 3},
...
mxPolyline.prototype.paintLine = function (a, b, c) {
    var d = mxUtils.getValue(this.style, mxConstants.STYLE_ARCSIZE, mxConstants.LINE_ARCSIZE) / 2, e = b[0],
        f = b[b.length - 1];
    a.begin();
    a.moveTo(e.x, e.y);
...
mxArrow.prototype.paintEdgeShape = function (a, b) {
    var c = mxConstants.ARROW_SPACING, d = mxConstants.ARROW_WIDTH, e = mxConstants.ARROW_SIZE, f = b[0],
        g = b[b.length - 1], h = g.x - f.x, k = g.y - f.y, l = Math.sqrt(h * h + k * k), m = l - 2 * c - e, h = h / l,
        k = k / l, l = d * k / 3, d = -d * h / 3, e = f.x - l / 2 + c * h, f = f.y - d / 2 + c * k, n = e + l,
        p = f + d, q = n + m * h, m = p + m * k, s = q + l, r = m + d, t = s - 3 * l, v = r - 3 * d;
    a.begin();
    a.moveTo(e, f);
    a.lineTo(n, p);
    a.lineTo(q, m);
...
mxText.prototype.updateBoundingBox = function () {
    ...
    if (!this.ignoreStringSize && null != a && "fill" != this.overflow && (!this.clipped || !this.ignoreClippedStringSize)) {
        ...
        if (null != a.ownerSVGElement) if (null != a.firstChild && null != a.firstChild.firstChild && "foreignObject" == a.firstChild.firstChild.nodeName) a = a.firstChild.firstChild,
            ...
            b = 0
        } else d = this.state.view.textDiv, null != this.offsetWidth && null != this.offsetHeight ? (c = this.wrap ? this.bounds.width : this.offsetWidth * this.scale, d = this.offsetHeight * this.scale) : null != d ? (this.updateFont(d), this.updateSize(d), mxUtils.isNode(this.value) ? d.innerHTML = this.value.outerHTML :
            (c = this.replaceLinefeeds ? this.value.replace(/\n/g, "\x3cbr/\x3e") : this.value, d.innerHTML = c), c = this.wrap ? this.bounds.width : d.offsetWidth * this.scale, d = d.offsetHeight * this.scale) : (c = this.wrap ? this.bounds.width : a.offsetWidth * this.scale, d = a.offsetHeight * this.scale);
...
mxText.prototype.paint = function (a) {
    ...
    var f = mxUtils.isNode(this.value) || this.dialect == mxConstants.DIALECT_STRICTHTML,
        g = f || a instanceof mxVmlCanvas2D ? "html" : "", h = this.value;
...
mxText.prototype.updateHtmlTransform = function () {
    ...
    0 != a ? (b[mxClient.CSS_PREFIX + "TransformOrigin"] = 100 * -c + "% " + 100 * -d + "%", b[mxClient.CSS_PREFIX + "Transform"] = "translate(" + 100 * c + "%," + 100 * d + "%)scale(" + this.scale + ") rotate(" + a + "deg)") : (b[mxClient.CSS_PREFIX + "TransformOrigin"] = "0% 0%", b[mxClient.CSS_PREFIX + "Transform"] = "scale(" + this.scale + ")translate(" + 100 * c + "%," + 100 * d + "%)");
...
mxText.prototype.updateHtmlFilter = function () {
    ...
    var h = h * d, g = g * d, e = this.getTextRotation() * (Math.PI / 180),
        f = parseFloat(parseFloat(Math.cos(e)).toFixed(8)),
        k = parseFloat(parseFloat(Math.sin(-e)).toFixed(8)), e = e % (2 * Math.PI);
    0 > e && (e += 2 * Math.PI);
    e %= Math.PI;
    e > Math.PI / 2 && (e = Math.PI - e);
    var l = Math.cos(e), m = Math.sin(-e), b = g * -(b + 0.5), c = h * -(c + 0.5),
...
mxText.prototype.updateValue = function () {
    if (mxUtils.isNode(this.value)) this.node.innerHTML = "", this.node.appendChild(this.value); else {
        ...
        if (null != b || null != c) if ("fill" == this.overflow) null != b && (this.node.style.backgroundColor =
            b), null != c && (this.node.style.border = "1px solid " + c); else {
            var d = "";
...
mxImageShape.prototype.redrawHtmlShape = function () {
    ...
    if (null != this.image) {
        ...
        this.flipH && this.flipV ? b += "progid:DXImageTransform.Microsoft.BasicImage(rotation\x3d2)" : this.flipH ? b += "progid:DXImageTransform.Microsoft.BasicImage(mirror\x3d1)" : this.flipV && (b += "progid:DXImageTransform.Microsoft.BasicImage(rotation\x3d2, mirror\x3d1)");
...
mxLabel.prototype.getIndicatorBounds = function (a, b, c, d) {
    var e = mxUtils.getValue(this.style, mxConstants.STYLE_IMAGE_ALIGN, mxConstants.ALIGN_LEFT),
        ...
        h = mxUtils.getNumber(this.style, mxConstants.STYLE_INDICATOR_HEIGHT, this.indicatorSize), k = this.spacing + 5;
...
mxConnector.prototype.createMarker = function (a, b, c) {
    ...
    b = c ? b[0] : b[d - 1];
    var d = b.x - e.x, f = b.y - e.y, g = Math.max(1, Math.sqrt(d * d + f * f)), e = d / g, d = f / g,
...
mxSwimlane.prototype.paintVertexShape = function (a, b, c, d, e) {
    var f = Math.min(e, mxUtils.getValue(this.style, mxConstants.STYLE_STARTSIZE, mxConstants.DEFAULT_STARTSIZE)),
        ...
        h = 1 == mxUtils.getValue(this.style, mxConstants.STYLE_SWIMLANE_LINE, 1), k = 0;
    a.translate(b, c);
...
mxGraphLayout.prototype.arrangeGroups = function (a, b) {
    ...
    try {
        for (var c = a.length - 1; 0 <= c; c--) {
            var d = a[c], e = this.graph.getChildVertices(d), f = this.graph.getBoundingBoxFromGeometry(e),
                g = this.graph.getCellGeometry(d), h = 0, k = 0;
...
mxCompactTreeLayout.prototype.dfs = function (a, b, c) {
    ...
    if (null != a && null == c[d] && !this.isVertexIgnored(a)) {
        c[d] = a;
        var e = this.createNode(a), d = this.graph.getModel(), f = null;
    ...
    try {
        for (var c = 0, d = null, e = null, f = [], g = b.getChildCount(a), h = 0; h < g; h++) {
            ...
            if (this.isVertexIgnored(k)) this.isEdgeIgnored(k) || (this.resetEdges && this.graph.resetEdge(k), this.disableEdgeStyle && this.setEdgeStyleEnabled(k, !1)); else {
                f.push(k);
                var l = this.getVertexBounds(k), d = null == d ? l.y : Math.min(d, l.y),
                    e = null == e ? l.x : Math.min(e, l.x), c = Math.max(c, Math.max(l.width, l.height))
            }
        }
...
mxParallelEdgeLayout.prototype.getEdgeId = function (a) {
    var b = this.graph.getView(), c = b.getState(a),
...
mxMedianHybridCrossingReduction.prototype.transpose = function (a, b) {
    for (var c = !0, d = 0; c && 10 > d++;) for (var e = 1 == a % 2 && 1 == d % 2, c = !1, f = 0; f < b.ranks.length; f++) {
        ...
        for (var n = m = l = null, p = null, q = null, s = null, r = null, t = null, v = null, w = null, k = 0; k < g.length - 1; k++) {
            ...
            for (var y = 0, z = 0, u = 0; u < q.length; u++) for (var x = 0; x < r.length; x++) q[u] > r[x] && y++, q[u] < r[x] && z++;
            for (u = 0; u < s.length; u++) for (x = 0; x < t.length; x++) s[u] > t[x] && y++, s[u] < t[x] && z++;
...
mxCoordinateAssignment.prototype.minNode = function (a) {
    ...
    for (f = 0; 0 < b.length && f <= a;) {
        var h = b.shift(), e = h.cell, k = h.weightedValue, l = parseInt(h.rankIndex),
            g = e.getNextLayerConnectedCells(k), m = e.getPreviousLayerConnectedCells(k), n = g.length, p = m.length,
            q = this.medianXValue(g, k + 1), s =
                this.medianXValue(m, k - 1), r = n + p, t = e.getGeneralPurposeVariable(k), v = t;
        0 < r && (v = (q * n + s * p) / r);
        n = !1;
        v < t - 1 ? 0 == l ? (e.setGeneralPurposeVariable(k, v), n = !0) : (l = d[k][l - 1], t = l.getGeneralPurposeVariable(k), t = t + l.width / 2 + this.intraCellSpacing + e.width / 2, t < v ? (e.setGeneralPurposeVariable(k, v), n = !0) : t < e.getGeneralPurposeVariable(k) - 1 && (e.setGeneralPurposeVariable(k, t), n = !0)) : v > t + 1 && (l == d[k].length - 1 ? (e.setGeneralPurposeVariable(k, v), n = !0) : (l = d[k][l + 1], t = l.getGeneralPurposeVariable(k), t = t - l.width / 2 - this.intraCellSpacing -
...
mxCoordinateAssignment.prototype.setEdgePosition = function (a) {
    ...
    if (101207 != a.temp[0]) {
        ...
        for (var e = 0, f = mxCellPath.create(a.edges[0]), f = this.jettyPositions[f], g = a.isReversed ? a.target.cell : a.source.cell, h = this.layout.graph, k = 0; k < a.edges.length; k++) {
            var l = a.edges[k], m = this.layout.getVisibleTerminal(l, !0), n = h.model.getTerminal(l, !0), p = [],
                q = a.isReversed;
            m != g && (q = !q);
            if (null != f) {
            ...
            for (; a.maxRank != a.minRank && s != t; s += r) {
                var n = a.x[s] + b, v = (this.rankTopY[m] + this.rankBottomY[m + 1]) / 2,
                    w = (this.rankTopY[m - 1] + this.rankBottomY[m]) / 2;
                if (q) var u = v, v = w, w = u;
                this.orientation == mxConstants.DIRECTION_NORTH || this.orientation == mxConstants.DIRECTION_SOUTH ? (p.push(new mxPoint(n, v)), p.push(new mxPoint(n, w))) : (p.push(new mxPoint(v, n)), p.push(new mxPoint(w, n)));
...
mxHierarchicalLayout.prototype.run = function (a) {
    ...
    } else for (e = 0; e < roots.length; e++) h = [], b.push(h), traverse(roots.get(e), !0, null, c, h, b, null);
...
mxGraphModel.prototype.updateEdgeParent = function (a, b) {
    ...
    if (this.isAncestor(b, c) && this.isAncestor(b, d) && (e = c == d ? this.getParent(c) : this.getNearestCommonAncestor(c, d), null != e && (this.getParent(e) != this.root || this.isAncestor(e, a)) && this.getParent(a) != e)) {
        ...
        if (null != c) {
            var f = this.getOrigin(this.getParent(a)), g = this.getOrigin(e), d = g.x - f.x, f = g.y - f.y,
                c = c.clone();
            c.translate(-d, -f);
...
var mxCellPath = {
    ...
    RectanglePerimeter: function (a, b, c, d) {
        b = a.getCenterX();
        var e = a.getCenterY(), f = Math.atan2(c.y - e, c.x - b), g = new mxPoint(0, 0), h = Math.PI,
            k = Math.PI / 2 - f, l = Math.atan2(a.height, a.width);
        ...
        var q = c.x -
                k, s = c.y - l, q = e ? Math.atan2(q, s) : Math.atan2(s, q), r = e ? Math.atan2(h, a) : Math.atan2(a, h),
            s = !1,
    ...
    try {
        ...
        if (null == this.wnd) {
            ...
            mxClient.link("stylesheet", mxClient.basePath +
                "/css/common.css", d);
            mxClient.IS_VML && (d.namespaces.add("v", "urn:schemas-microsoft-com:vml"), d.namespaces.add("o", "urn:schemas-microsoft-com:office:office"), d.createStyleSheet().cssText = "v\\:*{behavior:url(#default#VML)}o\\:*{behavior:url(#default#VML)}", mxClient.link("stylesheet", mxClient.basePath + "/css/explorer.css", d));
            var f = this.graph.getGraphBounds().clone(), g = this.graph.getView().getScale(), h = g / this.scale,
                k = this.graph.getView().getTranslate();
            this.autoOrigin || (this.x0 = -k.x * this.scale, this.y0 =
                -k.y * this.scale, f.width += f.x, f.height += f.y, f.x = 0, this.border = f.y = 0);
            f.width /= h;
            f.height /= h;
            var l = this.pageFormat.width - 2 * this.border, m = this.pageFormat.height - 2 * this.border,
            ...
            for (var t = this.getAppendices(this.pageFormat.width, this.pageFormat.height), r = 0; r < p; r++) for (var v = r * m / this.scale - this.y0 / this.scale + (f.y - k.y * g) / g, s = 0; s < n; s++) {
                if (null == this.wnd) return null;
                var w = s * l / this.scale - this.x0 / this.scale + (f.x - k.x * g) / g, u = r * n + s + 1,
                    c = this.renderPage(this.pageFormat.width, this.pageFormat.height, mxUtils.bind(this, function (a) {
                        this.addGraphFragment(-w,
                            -v, this.scale, u, a)
                    }));
...
mxCellEditor.prototype.init = function () {
    ...
    mxEvent.addListener(this.textarea, "keydown", mxUtils.bind(this, function (a) {
        ...
        (113 == a.keyCode || this.graph.isEnterStopsCellEditing() && 13 == a.keyCode && !mxEvent.isControlDown(a) && !mxEvent.isShiftDown(a) ? (this.graph.stopEditing(!1), mxEvent.consume(a)) : 27 == a.keyCode ? (this.graph.stopEditing(!0), mxEvent.consume(a)) : (this.clearOnChange && (this.clearOnChange = !1, this.textarea.value = ""), this.setModified(!0)))
    }));
...
mxCellEditor.prototype.resize = function () {
    if (null != this.textDiv) {
        var a = this.graph.getView().getState(this.editingCell), b = this.graph.isLabelClipped(a.cell),
            c = this.graph.isWrapping(a.cell);
        if (this.graph.getModel().isEdge(a.cell)) this.bounds.x = a.absoluteOffset.x, this.bounds.y = a.absoluteOffset.y, this.bounds.width = 0, this.bounds.height = 0; else if (null != this.bounds) {
            this.bounds.x = a.x;
            this.bounds.y = a.y;
        ...
        var d = this.textDiv.offsetWidth + 30, e = this.textDiv.offsetHeight + 16, d = Math.max(d, 40),
            e = Math.max(e, 20);
        b && (d = Math.min(this.bounds.width - 4, d), e = Math.min(this.bounds.height, e));
        var f = null != a.text ? a.text.margin : null;
        null == f && (f = mxUtils.getValue(a.style, mxConstants.STYLE_ALIGN, mxConstants.ALIGN_CENTER), a = mxUtils.getValue(a.style, mxConstants.STYLE_VERTICAL_ALIGN, mxConstants.ALIGN_MIDDLE), f = mxUtils.getAlignmentAsPoint(f,
            a));
        if (null != f) {
...
mxCellEditor.prototype.getEditorBounds = function (a) {
    var b = this.graph.getModel().isEdge(a.cell), c = this.graph.getView().scale, d = this.getMinimumSize(a),
        e = d.width, d = d.height, f = parseInt(a.style[mxConstants.STYLE_SPACING] || 2) * c,
...
mxCellRenderer.prototype.orderEdge = function (a) {
    ...
    if (b.graph.keepEdgesInForeground) {
        ...
        var d = a.shape.node, e = d.parentNode, c = c.getParent(a.cell), b = b.getState(c),
...
mxCellRenderer.prototype.installListeners = function (a) {
    ...
    mxEvent.addListener(a.shape.node, e, mxUtils.bind(this, function (c) {
        d = !1;
        "gestureend" == e ? (b.lastTouchTime = 0, b.gestureEnabled && (b.handleGesture(a, c), mxEvent.consume(c))) : this.isShapeEvent(a, c) && (b.dblClick(c, null != a.shape && mxEvent.getSource(c) == a.shape.content ? null : a.cell), mxEvent.consume(c))
    }))
};
...
mxCellRenderer.prototype.getLabelBounds = function (a) {
    ...
    a.text.updateMargin();
    d ? (d = a.text.getSpacing(), e.x += d.x * c, e.y += d.y * c, b = b.getCellGeometry(a.cell), null != b && (e.width = Math.max(0, a.text.margin.x * b.width * c - a.text.spacingLeft * c - a.text.spacingRight * c), e.height = Math.max(0, a.text.margin.y * b.height * c - a.text.spacingTop * c - a.text.spacingBottom * c))) : (a.text.isPaintBoundsInverted() && (d = e.x,
        e.x = e.y, e.y = d), e.x += a.x, e.y += a.y, e.width = Math.max(1, a.width), e.height = Math.max(1, a.height), b.isSwimlane(a.cell) && (b = b.getStartSize(a.cell), 0 < b.width ? (d = Math.min(e.width, b.width * c), a.shape.flipH && (e.x += e.width - d), e.width = d) : 0 < b.height && (d = Math.min(e.height, b.height * c), a.shape.flipV && (e.y += e.height - d), e.height = d)), this.rotateLabelBounds(a, e));
    return e
};
    ...
    if (null != a.overlays) {
        ...
        a.overlays.visit(function (d, h) {
            ...
            if (!a.view.graph.getModel().isEdge(a.cell) && null != a.shape && 0 != c) {
                var l = k.getCenterX(), m = k.getCenterY(),
...
mxCellRenderer.prototype.getControlBounds = function (a) {
    if (null != a.control) {
        var b = a.control.scale, c = a.control.bounds.width / b, b = a.control.bounds.height / b, d = a.view.scale,
            e = a.getCenterX(), f = a.getCenterY();
        if (!a.view.graph.getModel().isEdge(a.cell) && (e = a.x + c * d, f = a.y + b * d, null != a.shape)) {
            var g = a.shape.getShapeRotation();
            if (this.legacyControlPosition) g = mxUtils.getValue(a.style, mxConstants.STYLE_ROTATION, 0); else if (a.shape.isPaintBoundsInverted()) var h = (a.width - a.height) / 2,
                e = e + h, f = f - h;
...
var mxEdgeStyle = {
    ...
    ElbowConnector: function (a, b, c, d, e) {
        ...
        if (null != b && null != c) if (null != f) var k = Math.min(b.x, c.x),
            l = Math.max(b.x + b.width, c.x + c.width), h = Math.min(b.y, c.y),
            m = Math.max(b.y + b.height, c.y + c.height), f = a.view.transformControlPoint(a, f),
            g = f.y < h || f.y > m,
            h = f.x < k || f.x > l; else k = Math.max(b.x, c.x), l = Math.min(b.x + b.width, c.x + c.width), g = k == l, g || (h = Math.max(b.y, c.y), m = Math.min(b.y + b.height, c.y + c.height), h = h == m);
    ...
    SegmentConnector: function (a, b, c, d, e) {
        ...
        if (null != d && 0 < d.length) {
            for (var h = a.view.transformControlPoint(a, d[0]), m = b, n = f[0], p = !1, q = !1, p = h, s = d.length, r =
                0; 2 > r; r++) {
                var t = null != n && n.x == p.x, v = null != n && n.y == p.y,
                    w = null != m && p.y >= m.y && p.y <= m.y + m.height,
                    m = null != m && p.x >= m.x && p.x <= m.x + m.width, p = v || null == n && w,
                    q = t || null == n && m;
                if (null != n && !v && !t && (w || m)) {
                    g = w ? !1 : !0;
                    break
    ...
    routePatterns: [[[513, 2308, 2081, 2562], [513, 1090, 514, 2184, 2114, 2561], [513, 1090, 514, 2564, 2184, 2562], [513, 2308, 2561, 1090, 514, 2568, 2308]], [[514, 1057, 513, 2308, 2081, 2562], [514, 2184, 2114, 2561], [514, 2184,
        2562, 1057, 513, 2564, 2184], [514, 1057, 513, 2568, 2308, 2561]], [[1090, 514, 1057, 513, 2308, 2081, 2562], [2114, 2561], [1090, 2562, 1057, 513, 2564, 2184], [1090, 514, 1057, 513, 2308, 2561, 2568]], [[2081, 2562], [1057, 513, 1090, 514, 2184, 2114, 2561], [1057, 513, 1090, 514, 2184, 2562, 2564], [1057, 2561, 1090, 514, 2568, 2308]]],
    ...
    OrthConnector: function (a, b, c, d, e) {
        var f = a.view.graph, g = null == b ? !1 : f.getModel().isEdge(b.cell),
        ...
        if (null != d && 0 < d.length || g || f) mxEdgeStyle.SegmentConnector(a, b, c, d, e); else {
            ...
            var g = null != b ? b.y : h.y, l = null != b ? b.width :
                    1, m = null != b ? b.height : 1, n = null != c ? c.x : k.x, p = null != c ? c.y : k.y,
                q = null != c ? c.width : 1, s = null != c ? c.height : 1, f = a.view.scale * mxEdgeStyle.orthBuffer,
            ...
            for (l = k = 0; l < r.length; l++) {
                ...
                var t = 0 < (r[l] & mxEdgeStyle.TARGET_MASK), q = 0 < (r[l] & mxEdgeStyle.SOURCE_MASK),
                    n = (r[l] & mxEdgeStyle.SIDE_MASK) >> 5, n = n << g;
                15 < n && (n >>= 4);
...
mxGraphView.prototype.validateBackground = function () {
    ...
    this.graph.pageVisible ? (b = this.getBackgroundPageBounds(), null == this.backgroundPageShape ? (this.backgroundPageShape = this.createBackgroundPageShape(b), this.backgroundPageShape.scale = this.scale, this.backgroundPageShape.isShadow = !0, this.backgroundPageShape.dialect = this.graph.dialect, this.backgroundPageShape.init(this.backgroundPane), this.backgroundPageShape.redraw(), mxEvent.addListener(this.backgroundPageShape.node, "dblclick", mxUtils.bind(this,
        ...
        this.graph.fireMouseEvent(mxEvent.MOUSE_UP,
            new mxMouseEvent(a))
    }))) : (this.backgroundPageShape.scale = this.scale, this.backgroundPageShape.bounds = b, this.backgroundPageShape.redraw())) : null != this.backgroundPageShape && (this.backgroundPageShape.destroy(), this.backgroundPageShape = null)
};
                ...
                if (null != e) {
                    ...
                    if (c.isVertex(b)) {
                        if (e.relative && (f = mxUtils.toRadians(a.style[mxConstants.STYLE_ROTATION] || "0"), 0 != f)) {
                            var e = Math.cos(f), f = Math.sin(f), g = new mxPoint(d.getCenterX(), d.getCenterY()),
...
mxGraph.prototype.setCellWarning = function (a, b, c, d) {
    if (null != b && 0 < b.length) return c = null != c ? c : this.warningImage, b = new mxCellOverlay(c, "\x3cfont color\x3dred\x3e" + b + "\x3c/font\x3e"), d && b.addListener(mxEvent.CLICK, mxUtils.bind(this, function (b, c) {
...
mxGraph.prototype.getPreferredPageSize = function (a, b, c) {
    a = this.view.scale;
    var d = this.view.translate, e = this.pageFormat, f = a * this.pageScale,
...
mxGraph.prototype.updatePageBreaks = function (a, b, c) {
    var d = this.view.scale, e = this.view.translate, f = this.pageFormat, g = d * this.pageScale,
    ...
    if (null != this.horizontalPageBreaks) {
        for (g = 0; g <= f; g++) {
            ...
            null != this.horizontalPageBreaks[g] ? (this.horizontalPageBreaks[g].scale = 1, this.horizontalPageBreaks[g].points = h, this.horizontalPageBreaks[g].redraw()) : (h = new mxPolyline(h, this.pageBreakColor, this.scale), h.dialect = this.dialect, h.isDashed = this.pageBreakDashed, h.scale = d, h.init(this.view.backgroundPane), h.redraw(), this.horizontalPageBreaks[g] = h)
        }
    ...
    if (null != this.verticalPageBreaks) {
        for (g = 0; g <= a; g++) h = [new mxPoint(1, e.y + g * e.height), new mxPoint(b, e.y + g * e.height)], null != this.verticalPageBreaks[g] ? (this.verticalPageBreaks[g].scale = 1, this.verticalPageBreaks[g].points = h, this.verticalPageBreaks[g].redraw()) : (h = new mxPolyline(h, this.pageBreakColor, d), h.dialect = this.dialect, h.isDashed = this.pageBreakDashed, h.scale = d, h.init(this.view.backgroundPane), h.redraw(),
...
mxGraph.prototype.getCellStyle = function (a) {
    var b = this.model.getStyle(a), c = null,
            ...
            for (e = 0; e < a.length; e++) {
                for (var g = this.getConnections(a[e]), h = 0; h < g.length; h++) if (f = mxCellPath.create(g[h]), null == d[f]) {
                    ...
                    if (null != k) {
                        ...
                        if (null != l) {
                            var k = k.clone(), m = l.getVisibleTerminal(!0) == a[e], n = l.absolutePoints,
                                p = m ? 0 : n.length -
                                    1;
        ...
        try {
            ...
            if (null != c && null != d) {
                ...
                if (this.isSwimlane(a)) {
                    var f = this.view.getState(a), g = null != f ? f.style : this.getCellStyle(a),
...
mxGraph.prototype.handleGesture = function (a, b) {
    if (0.2 < Math.abs(1 - b.scale)) {
        var c = this.view.scale, d = this.view.translate, e = a.width * b.scale, f = a.height * b.scale,
            g = a.y - (f - a.height) / 2,
...
mxGraph.prototype.extendParent = function (a) {
    if (null != a) {
        ...
        if (null != b && (null != c && !this.isCellCollapsed(b)) && (a = this.model.getGeometry(a), null != a && (c.width < a.x + a.width || c.height < a.y + a.height))) c = c.clone(), c.width = Math.max(c.width, a.x + a.width), c.height = Math.max(c.height, a.y + a.height), this.cellsResized([b], [c])
    }
};
...
mxGraph.prototype.constrainChild = function (a) {
    if (null != a) {
        ...
        if (null != b && null != c && !b.relative && (b.x < c.x || b.y < c.y || c.width < b.x + b.width || c.height < b.y + b.height)) a = this.getOverlap(a), 0 < c.width && (b.x = Math.min(b.x, c.x + c.width - (1 - a) * b.width)), 0 < c.height && (b.y = Math.min(b.y, c.y + c.height - (1 - a) * b.height)), b.x = Math.max(b.x, c.x - b.width * a), b.y = Math.max(b.y, c.y - b.height * a)
    }
};
            ...
            for (c = 0; c < a.length; c++) {
                ...
                if (null != e) for (d = 0; d < e.length; d++) {
                    var f = this.view.getState(e[d]),
                        ...
                        k = mxCellPath.create(g), l = mxCellPath.create(h);
...
mxGraph.prototype.getConnectionPoint = function (a, b) {
    var c = null;
    if (null != a) {
        var d = this.view.getPerimeterBounds(a), e = new mxPoint(d.getCenterX(), d.getCenterY()),
            f = a.style[mxConstants.STYLE_DIRECTION], g = 0;
        ...
        if (null != b.point) {
            ...
            if (this.getModel().isVertex(a.cell)) {
                var n = a.style[mxConstants.STYLE_FLIPH], p =
        ...
        b.perimeter ? (0 != g && null != c && (h = d = 0, 90 == g ? h = 1 : 180 == g ? d = -1 : 270 == f && (h = -1), c = mxUtils.getRotatedPoint(c, d, h, e)), null != c && b.perimeter && (c = this.view.getPerimeterPoint(a,
            c, !1))) : f += g;
        ...
        try {
            ...
            for (e = 0; e < a.length; e++) if (this.model.isEdge(a[e])) {
                ...
                if (null != g) {
                    ...
                    if (null != h && null != k) {
                        var g = g.clone(), l = -k.origin.x, m = -k.origin.y, n = h.absolutePoints,
...
mxGraph.prototype.getPointForEvent = function (a, b) {
    var c = mxUtils.convertPoint(this.container, mxEvent.getClientX(a), mxEvent.getClientY(a)), d = this.view.scale,
        e = this.view.translate, f = !1 != b ? this.gridSize / 2 : 0;
...
mxGraph.prototype.fireMouseEvent = function (a, b, c) {
    ...
    if (mxClient.IS_TOUCH && this.doubleTapEnabled && a == mxEvent.MOUSE_DOWN) {
        ...
        d - this.lastTouchTime < this.doubleTapTimeout && Math.abs(this.lastTouchX - b.getX()) < this.doubleTapTolerance && Math.abs(this.lastTouchY - b.getY()) < this.doubleTapTolerance ? (this.lastTouchTime = 0, this.dblClick(b.getEvent(), b.getCell()), b.getEvent().cancelBubble = !0) : (this.lastTouchX =
            b.getX(), this.lastTouchY = b.getY(), this.lastTouchTime = d)
    }
    d = 2 != b.getEvent().detail;
    if (mxClient.IS_IE && "CSS1Compat" == document.compatMode) {
        if (null != this.lastMouseX && Math.abs(this.lastMouseX - b.getX()) > this.doubleTapTolerance || null != this.lastMouseY && Math.abs(this.lastMouseY - b.getY()) > this.doubleTapTolerance) d = !0;
...
mxCellOverlay.prototype.getBounds = function (a) {
    var b = a.view.graph.getModel().isEdge(a.cell), c = a.view.scale, d = null, e = this.image.width,
        f = this.image.height;
...
mxOutline.prototype.update = function (a) {
    if (null != this.source) {
        var b = this.source.view.scale, c = this.source.getGraphBounds(),
            ...
            e = c.clone();
        e.add(d);
        var f = this.getSourceContainerSize(), d = Math.max(f.width / b, e.width), b = Math.max(f.height / b, e.height),
        ...
        if (0 < e) {
            ...
            var b = this.source.view.translate, f = b.x + this.source.panDx, g = b.y + this.source.panDy,
...
mxOutline.prototype.mouseDown = function (a, b) {
    this.enabled && this.showViewport && (this.zoom = b.isSource(this.sizer), this.startX = b.getX(), this.startY = b.getY(), this.active = !0, this.source.useScrollbarsForPanning && mxUtils.hasScrollbars(this.source.container) ? (this.dx0 = this.source.container.scrollLeft, this.dy0 = this.source.container.scrollTop) : this.dy0 = this.dx0 = 0);
    b.consume()
};
mxOutline.prototype.mouseMove = function (a, b) {
    if (this.active) {
        ...
        if (this.zoom) e = this.source.container, d = c / (e.clientWidth / e.clientHeight), e = new mxRectangle(this.bounds.x, this.bounds.y, Math.max(1, this.bounds.width + c), Math.max(1, this.bounds.height + d)), this.selectionBorder.bounds = e, this.selectionBorder.redraw(); else {
            var f =
...
mxOutline.prototype.mouseUp = function (a, b) {
    if (this.active) {
        ...
        if (0 < Math.abs(c) || 0 < Math.abs(d)) {
            ...
            } else if (!this.source.useScrollbarsForPanning || !mxUtils.hasScrollbars(this.source.container)) this.source.panGraph(0, 0), c /= this.outline.getView().scale, d /= this.outline.getView().scale, e = this.source.getView().translate, this.source.getView().setTranslate(e.x -
                c, e.y - d);
            this.update();
            b.consume()
        }
...
mxSpaceManager.prototype.cellResized = function (a) {
    ...
    if (null != e && null != f) {
        ...
        if (null != g && null != h) {
            var k = c.translate, l = c.scale, c = e.x - f.origin.x - k.x * l, f = e.y - f.origin.y - k.y * l,
                k = e.x + e.width, m = e.y + e.height, n = e.width - h.width * l + c - h.x * l,
                p = e.height - h.height * l + f - h.y * l, q = 1 - h.width * l / e.width,
...
mxSpaceManager.prototype.getCellsToShift = function (a) {
    var b = this.getGraph(), c = b.getModel().getParent(a.cell), d = this.isShiftDownwards(),
...
mxCellStatePreview.prototype.show = function (a) {
    ...
    for (d in this.deltas) {
        var e = mxCellPath.resolve(c, d), f = this.graph.view.getState(e), g = this.deltas[d],
...
mxGraphHandler.prototype.mouseMove = function (a, b) {
    ...
    if (!b.isConsumed() && c.isMouseDown && null != this.cell && null != this.first && null != this.bounds) {
        var d = mxUtils.convertPoint(c.container, b.getX(), b.getY()), e = d.x - this.first.x, f = d.y - this.first.y,
            d = c.tolerance;
        if (null != this.shape || Math.abs(e) > d || Math.abs(f) > d) {
            ...
            var g = c.isGridEnabledEvent(b.getEvent()),
                d = !0;
            if (null != this.guide && this.useGuidesForEvent(b)) f = this.guide.move(this.bounds, new mxPoint(e, f), g), d = !1, e = f.x, f = f.y; else if (g) var h = c.getView().translate,
                k = c.getView().scale, g = this.bounds.x - (c.snap(this.bounds.x / k - h.x) + h.x) * k,
                h = this.bounds.y - (c.snap(this.bounds.y / k - h.y) + h.y) * k, f = this.snap(new mxPoint(e, f)),
                e = f.x - g, f = f.y - h;
    ...
    if (!b.isConsumed()) {
        ...
        if (null != this.cell && null != this.first && null != this.shape && null != this.currentDx && null != this.currentDy) {
            var d = c.getView().scale,
                ...
                f = this.currentDx / d, d = this.currentDy / d, g = b.getCell();
...
mxPanningHandler.prototype.mouseMove = function (a, b) {
    var c = b.getX() - this.startX, d = b.getY() - this.startY;
    if (this.active) this.previewEnabled && (this.useGrid && (c = this.graph.snap(c), d = this.graph.snap(d)), this.graph.panGraph(c + this.dx0, d + this.dy0)), this.fireEvent(new mxEventObject(mxEvent.PAN, "event", b)), b.consume(); else if (this.panningTrigger) {
        var e = this.active;
...
mxPanningHandler.prototype.mouseUp = function (a, b) {
    ...
    if (this.active) {
        ...
        this.fireEvent(new mxEventObject(mxEvent.PAN_END, "event",
            b));
        b.consume()
    } else this.popupTrigger && (c < this.graph.tolerance && d < this.graph.tolerance) && (c = this.getCellForPopupEvent(b), this.graph.isEnabled() && this.selectOnPopup && null != c && !this.graph.isCellSelected(c) ? this.graph.setSelectionCell(c) : this.clearSelectionOnBackground && null == c && this.graph.clearSelection(), this.graph.tooltipHandler.hide(), d = mxUtils.getScrollOrigin(), d = new mxPoint(b.getX() + d.x, b.getY() + d.y), this.popup(d.x + 1, d.y + 1, c, b.getEvent()), b.consume());
...
mxConnectionHandler.prototype.createMarker = function () {
    ...
    a.getCell = mxUtils.bind(this, function (b, c) {
        ...
        null != c ? this.isConnecting() ? null != this.previous && (this.error = this.validateConnection(this.previous.cell, c), null != this.error && 0 == this.error.length && (c = null, this.isCreateTarget() && (this.error = null))) : this.isValidSource(c) || (c = null) : this.isConnecting() &&
...
mxConnectionHandler.prototype.tapAndHold = function (a, b) {
    null != b && (this.marker.currentColor = this.marker.validColor, this.marker.markedState = b, this.marker.mark(), this.first = new mxPoint(a.getGraphX(), a.getGraphY()), this.edgeState = this.createEdgeState(a), this.previous = b, this.fireEvent(new mxEventObject(mxEvent.START, "state", this.previous)))
};
    ...
    if (!b.isConsumed() && (this.ignoreMouseDown || null != this.first || !this.graph.isMouseDown)) {
        ...
        if (null != this.first) {
            ...
            if (null != this.selectedIcon) {
                ...
                this.targetConnectImage ? (g = this.getIconPosition(this.selectedIcon, this.currentState), this.selectedIcon.bounds.x = g.x, this.selectedIcon.bounds.y = g.y) : (g = new mxRectangle(b.getGraphX() + this.connectIconOffset.x, b.getGraphY() + this.connectIconOffset.y, g, h), this.selectedIcon.bounds = g);
            ...
            if (null != this.edgeState) {
                ...
                null != this.currentState &&
                (null == d && (d = this.graph.getConnectionConstraint(this.edgeState, this.previous, !1)), this.edgeState.setAbsoluteTerminalPoint(null, !1), this.graph.view.updateFixedTerminalPoint(this.edgeState, this.currentState, !1, d));
                f = null;
...
mxConstraintHandler.prototype.update = function (a, b) {
    if (this.isEnabled() && !this.isEventIgnored(a)) {
        var c = this.getTolerance(), d = new mxRectangle(a.getGraphX() - c, a.getGraphY() - c, 2 * c, 2 * c),
            e = null != a.getCell() ? this.graph.isCellConnectable(a.getCell()) : !1;
        if (null == this.currentFocusArea || !mxUtils.intersects(this.currentFocusArea, d) || null != a.getState() && null != this.currentFocus && e) if (this.currentFocusArea = null, a.getState() != this.currentFocus) if (this.currentFocus = null, this.constraints = null != a.getState() && e ? this.graph.getAllConnectionConstraints(a.getState(),
            ...
            for (e = 0; e < this.constraints.length; e++) {
                var f = this.graph.getConnectionPoint(a.getState(), this.constraints[e]),
                    g = this.getImageForConstraint(a.getState(), this.constraints[e],
                        f), h = g.src, g = new mxRectangle(f.x - g.width / 2, f.y - g.height / 2, g.width, g.height),
        ...
        if (null != this.focusIcons && null != this.constraints && (null == a.getState() || this.currentFocus == a.getState())) for (e =
                                                                                                                                         0; e < this.focusIcons.length; e++) if (mxUtils.intersects(this.focusIcons[e].bounds, d)) {
            ...
            null == this.focusHighlight ? (c = new mxRectangleShape(c, null, this.highlightColor, 3), c.dialect = this.graph.dialect == mxConstants.DIALECT_SVG ? mxConstants.DIALECT_SVG : mxConstants.DIALECT_VML, c.init(this.graph.getView().getOverlayPane()), this.focusHighlight =
...
mxVertexHandler.prototype.init = function () {
    ...
    if (this.rotationEnabled && (0 >=
        mxGraphHandler.prototype.maxCells || this.graph.getSelectionCount() < mxGraphHandler.prototype.maxCells)) this.rotationShape = this.createSizer("pointer", mxEvent.ROTATION_HANDLE, mxConstants.HANDLE_SIZE + 3, mxConstants.HANDLE_FILLCOLOR), this.sizers.push(this.rotationShape);
    this.redraw()
};
...
mxVertexHandler.prototype.getHandleForEvent = function (a) {
    ...
    if (null != this.sizers) for (var b = this.tolerance, b = this.allowHandleBoundsCheck && (mxClient.IS_IE || 0 < b) ? new mxRectangle(a.getGraphX() - b, a.getGraphY() - b, 2 * b, 2 * b) : null, c = 0; c < this.sizers.length; c++) if (a.isSource(this.sizers[c]) || null != b && mxUtils.intersects(this.sizers[c].bounds, b)) return c;
    return null
};
...
mxVertexHandler.prototype.start = function (a, b, c) {
    ...
    !(mxClient.IS_SVG && 0 != Number(this.state.style[mxConstants.STYLE_ROTATION] || "0")) && null != this.state.text && this.state.text.node.parentNode == this.graph.container ? (this.preview.dialect = mxConstants.DIALECT_STRICTHTML, this.preview.init(this.graph.container)) :
...
mxVertexHandler.prototype.mouseMove = function (a, b) {
    if (!b.isConsumed() && null != this.index) {
        var c = new mxPoint(b.getGraphX(), b.getGraphY()), d = this.graph.isGridEnabledEvent(b.getEvent()),
        ...
        if (this.index == mxEvent.LABEL_HANDLE) d && (c.x = this.graph.snap(c.x / e) * e, c.y = this.graph.snap(c.y / e) * e), this.moveSizerTo(this.sizers[this.sizers.length - 1], c.x, c.y); else if (this.index == mxEvent.ROTATION_HANDLE) {
            ...
            this.rotationRaster && (f = c.x - this.state.getCenterX(), g = c.y - this.state.getCenterY(), f = Math.abs(Math.sqrt(f * f + g * g) - this.state.height / 2 - 20), f = Math.max(1, 5 * Math.min(3, Math.max(0, Math.round(80 / Math.abs(f))))), this.currentAlpha = Math.round(this.currentAlpha / f) * f);
            this.selectionBorder.rotation = this.currentAlpha;
            this.selectionBorder.redraw()
        } else {
            var h = mxUtils.toRadians(this.state.style[mxConstants.STYLE_ROTATION] || "0"), k = Math.cos(-h),
                l = Math.sin(-h), m = new mxPoint(this.state.getCenterX(), this.state.getCenterY()),
                f = c.x - this.startX, g = c.y - this.startY, c = this.graph.view.translate, n = l * f + k * g,
                f = k * f - l * g;
...
mxVertexHandler.prototype.mouseUp = function (a, b) {
    if (!b.isConsumed() && null != this.index && null != this.state) {
        ...
        this.graph.getModel().beginUpdate();
        try {
            if (this.index == mxEvent.ROTATION_HANDLE) null != this.currentAlpha && this.rotateCell(this.state.cell, this.currentAlpha - (this.state.style[mxConstants.STYLE_ROTATION] || 0)); else {
                var d = this.graph.isGridEnabledEvent(b.getEvent()),
                    e = mxUtils.toRadians(this.state.style[mxConstants.STYLE_ROTATION] || "0"), f = Math.cos(-e),
                    g = Math.sin(-e),
                    h = c.x - this.startX, k = c.y - this.startY, c = g * h + f * k, h = f * h - g * k, k = c,
...
mxVertexHandler.prototype.rotateCell = function (a, b) {
    ...
    if (c.isVertex(a)) {
        ...
        if (this.state.cell != a && (d = this.graph.getCellGeometry(a), null != d && !d.relative)) if (0 != b) {
            ...
            if (!d.relative && null != f) {
                var g = mxUtils.toRadians(b), e = Math.cos(g), g = Math.sin(g),
                    h = new mxPoint(d.getCenterX(), d.getCenterY()), f = new mxPoint(f.width / 2, f.height / 2),
                    e = mxUtils.getRotatedPoint(h, e, g, f), d = d.clone();
                d.x = e.x - d.width / 2;
                d.y = e.y - d.height / 2;
                c.setGeometry(a, d)
            }
...
mxVertexHandler.prototype.redraw = function () {
    ...
    if (null != this.sizers) {
        ...
        if (this.singleSizer) this.moveSizerTo(this.sizers[0], b, c); else {
            ...
            if (1 < this.sizers.length) {
                var f = mxUtils.toRadians(a.style[mxConstants.STYLE_ROTATION] || "0"), g = Math.cos(f), f = Math.sin(f),
                    h = new mxPoint(a.getCenterX(),
                        a.getCenterY()), k = mxUtils.getRotatedPoint(new mxPoint(a.x, a.y), g, f, h);
    ...
    null != this.rotationShape && (f = mxUtils.toRadians(this.state.style[mxConstants.STYLE_ROTATION] ||
        "0"), g = Math.cos(f), f = Math.sin(f), h = new mxPoint(this.state.getCenterX(), this.state.getCenterY()), k = mxUtils.getRotatedPoint(new mxPoint(a.x + a.width / 2, a.y - 16), g, f, h), this.moveSizerTo(this.rotationShape, k.x, k.y));
...
mxVertexHandler.prototype.destroy = function () {
    ...
    if (null != this.sizers) for (var a = 0; a < this.sizers.length; a++) this.sizers[a].destroy(), this.sizers[a] = null
};
    ...
    mxEvent.addGestureListeners(this.shape.node, mxUtils.bind(this, function (a) {
        ...
        if (null != this.index) {
            var d = mxUtils.convertPoint(this.graph.container, mxEvent.getClientX(a),
                mxEvent.getClientY(a)), c = this.graph.getCellAt(d.x, d.y);
...
mxEdgeHandler.prototype.getHandleForEvent = function (a) {
    ...
    if (a.isSource(this.labelShape) && "hidden" != this.labelShape.node.style.visibility || a.isSource(this.state.text)) if (!mxClient.IS_SF &&
...
mxEdgeHandler.prototype.mouseDown = function (a, b) {
    ...
    null != c && (!b.isConsumed() && this.graph.isEnabled() && !this.graph.isForceMarqueeEvent(b.getEvent())) && (this.removeEnabled && this.isRemovePointEvent(b.getEvent()) ? this.removePoint(this.state, c) : (c != mxEvent.LABEL_HANDLE || this.graph.isLabelMovable(b.getCell())) && this.start(b.getX(), b.getY(), c), b.consume())
};
...
mxEdgeHandler.prototype.getPointForEvent = function (a) {
    var b = new mxPoint(a.getGraphX(), a.getGraphY()), c = this.getSnapToTerminalTolerance(), d = this.graph.getView(),
        e = !1, f = !1;
...
mxEdgeHandler.prototype.updatePreviewState = function (a, b, c) {
    var d = this.isSource ? c : this.state.getVisibleTerminalState(!0),
        ...
        f = this.graph.getConnectionConstraint(a, d, !0), g = this.graph.getConnectionConstraint(a, e, !1),
...
mxEdgeHandler.prototype.redraw = function () {
    ...
    if (null != this.bends && 0 < this.bends.length) {
        ...
        this.bends[0].redraw();
        var d = this.abspoints[c], e = this.abspoints[c].x, c = this.abspoints[c].y, f = this.bends.length - 1,
...
mxEdgeHandler.prototype.redrawInnerBends = function (a, b) {
    ...
    if (null != c) {
        ...
        for (var d = 1; d < this.bends.length - 1; d++) if (null != this.bends[d]) if (null != this.abspoints[d]) {
            var e = this.abspoints[d].x, f = this.abspoints[d].y, g = this.bends[d].bounds;
...
mxEdgeHandler.prototype.destroy = function () {
    ...
    null != this.constraintHandler && (this.constraintHandler.destroy(), this.constraintHandler = null);
    if (null != this.bends) for (var a = 0; a < this.bends.length; a++) null != this.bends[a] && (this.bends[a].destroy(), this.bends[a] = null)
};
...
mxElbowEdgeHandler.prototype.redrawInnerBends = function (a, b) {
    var c = this.graph.getModel().getGeometry(this.state.cell).points, c = null != c ? c[0] : null,
        c = null == c ? new mxPoint(a.x + (b.x - a.x) / 2, a.y + (b.y - a.y) / 2) : new mxPoint(this.graph.getView().scale * (c.x + this.graph.getView().translate.x + this.state.origin.x), this.graph.getView().scale * (c.y + this.graph.getView().translate.y + this.state.origin.y)),
        d = this.bends[1].bounds, e = d.width, d = d.height;
    null == this.handleImage && (d = e = mxConstants.HANDLE_SIZE);
    var f = new mxRectangle(Math.round(c.x -
        e / 2), Math.round(c.y - d / 2), e, d);
    null == this.handleImage && ("hidden" != this.labelShape.node.style.visibility && mxUtils.intersects(f, this.labelShape.bounds)) && (e += 3, d += 3, f = new mxRectangle(Math.round(c.x - e / 2), Math.round(c.y - d / 2), e, d));
...
function mxKeyHandler(a, b) {
    null != a && (this.graph = a, this.target = b || document.documentElement, this.normalKeys = [], this.shiftKeys = [], this.controlKeys = [], this.controlShiftKeys = [], mxEvent.addListener(this.target, "keydown", mxUtils.bind(this, function (a) {
        this.keyDown(a)
    })), mxClient.IS_IE && mxEvent.addListener(window, "unload", mxUtils.bind(this, function () {
        this.destroy()
    })))
...
mxTooltipHandler.prototype.init = function () {
    null != document.body && (this.div = document.createElement("div"), this.div.className = "mxTooltip", this.div.style.visibility = "hidden", this.div.style.zIndex = this.zIndex, document.body.appendChild(this.div), mxEvent.addListener(this.div, "mousedown", mxUtils.bind(this, function (a) {
        this.hideTooltip()
    })))
};
...
mxTooltipHandler.prototype.reset = function (a, b) {
    ...
    if (b && this.isEnabled() && null != a.getState() && (null == this.div || "hidden" == this.div.style.visibility)) {
        var c = a.getState(), d = a.getSource(), e = a.getX(), f = a.getY(),
...
function mxCellHighlight(a, b, c, d) {
    null != a && (this.graph = a, this.highlightColor = null != b ? b : mxConstants.DEFAULT_VALID_COLOR, this.strokeWidth = null != c ? c : mxConstants.HIGHLIGHT_STROKEWIDTH, this.dashed = null != d ? d : !1, this.repaintHandler = mxUtils.bind(this, function () {
        this.repaint()
    }), this.graph.getView().addListener(mxEvent.SCALE, this.repaintHandler), this.graph.getView().addListener(mxEvent.TRANSLATE, this.repaintHandler), this.graph.getView().addListener(mxEvent.SCALE_AND_TRANSLATE, this.repaintHandler), this.graph.getModel().addListener(mxEvent.CHANGE,
...
mxCellHighlight.prototype.repaint = function () {
    if (null != this.state && null != this.shape) {
        var a = 0;
        this.graph.model.isEdge(this.state.cell) ? this.shape.points = this.state.absolutePoints : (this.shape.bounds = new mxRectangle(this.state.x - this.spacing, this.state.y - this.spacing, this.state.width + 2 * this.spacing, this.state.height + 2 * this.spacing), a = Number(this.state.style[mxConstants.STYLE_ROTATION] || "0"));
...
mxDefaultPopupMenu.prototype.addItems = function (a, b, c, d, e, f, g) {
    for (var h = !1; null != f;) {
        if ("add" == f.nodeName) {
            ...
            if (null == k || e[k]) {
                var k = f.getAttribute("as"), k = mxResources.get(k) || k, l = mxUtils.eval(mxUtils.getTextContent(f)),
                    m = f.getAttribute("action"), n = f.getAttribute("icon"), p = f.getAttribute("iconCls");
...
mxEditor.prototype.getTitle = function () {
    for (var a = "", b = this.graph, c = b.getCurrentRoot(); null != c && null != b.getModel().getParent(b.getModel().getParent(c));) b.isValidRoot(c) && (a = " \x3e " + b.convertValueToString(c) + a), c = b.getModel().getParent(c);
            ...
            for (c = c.firstChild; null != c;) {
                if (c.nodeType == mxConstants.NODETYPE_ELEMENT && !this.processInclude(a, c, d)) if ("separator" == c.nodeName) d.addSeparator(); else if ("br" == c.nodeName) d.toolbar.addBreak(); else if ("hr" == c.nodeName) d.toolbar.addLine(); else if ("add" == c.nodeName) {
                    var f = c.getAttribute("as"), f = mxResources.get(f) || f, g = c.getAttribute("icon"),
                        h = c.getAttribute("pressedIcon"), k = c.getAttribute("action"), l = c.getAttribute("mode"),
                        m = c.getAttribute("template"), n = "0" != c.getAttribute("toggle"),
                        p = mxUtils.getTextContent(c), q = null;
                    if (null != k) q = d.addItem(f, g, k, h); else if (null != l) var s = mxUtils.eval(p),
                        q = d.addMode(f, g, l, h, s); else if (null != m || null != p && 0 < p.length) q = e.templates[m], m = c.getAttribute("style"), null != q && null != m && (q = q.clone(), q.setStyle(m)), m = null, null != p && 0 < p.length && (m = mxUtils.eval(p)), q = d.addPrototype(f, g, q, h, m, n); else if (h = mxUtils.getChildNodes(c),
            ...
            if ("add" == a.nodeName) {
                ...
                if (null != e) g = document.getElementById(e), null != g && null != f && (g.style.cssText += ";" + f); else {
                    var e = parseInt(a.getAttribute("x")), h = parseInt(a.getAttribute("y")),
                        k = a.getAttribute("width"), l = a.getAttribute("height"),
