...
EditorUi.prototype.saveFileInput = function(forceDialog)
{
	if (!forceDialog && this.editor.filename != null)
	{
		this.saveInput(this.editor.getOrCreateFilename());
	}
	else
	{
		this.showDialog(new SaveInputDialog(this).container, 300, 100, true, true);
	}
};
