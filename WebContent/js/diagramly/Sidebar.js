(function()
{
	...
	Sidebar.prototype.init = function()
	{
		...
		/*Aggiungere procedura per lettura dinamica del nome*/
	...
	Sidebar.prototype.addErPalette = function()
	{
		...
		this.addPalette('er', mxResources.get('entityRelation'), false, mxUtils.bind(this, function(content)
		{
			...
			content.appendChild(this.createEdgeTemplate('edgeStyle=none;' + mxConstants.STYLE_ENDARROW + '=ERzeroToMany;endFill=1;myname=cccProva', w, h, '', '0 to many optional', false));
